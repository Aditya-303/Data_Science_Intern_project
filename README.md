...
Aligned on daily timestamps

Created key metrics (PnL, win rate, leverage, trade frequency)
...
Greed regimes increase trading activity.
...
Allow controlled scaling during Greed.

Prioritize quality trades in volatile conditions.
